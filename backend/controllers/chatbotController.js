        ...
        const response = await axios.post(
            MISTRAL_API_URL, 
            {
                ...
                messages: [
                    {
                        role: "system",
                        content: "You are EduBot, an educational assistant for the EduConnect platform. You help students with their studies, explain concepts, and provide guidance on educational topics."
                    },
                    {
                        role: "user",
                        content: message
