  ...
  return (
    <div className="placement-drive">
      ...
      <div className="intro-section">
        <p>Welcome to the EduConnect Placement Drive! Your one-stop platform to prepare for job opportunities, enhance your skills, and receive placement support.</p>
